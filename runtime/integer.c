...
static struct Value *rt_Integer__add__(unsigned int argc, struct Value **argv) {
...
static struct Value *rt_Integer__sub__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *other = argv[1];
    struct Value *result;
    union {
...
static struct Value *rt_Integer__mul__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *other = argv[1];
    struct Value *result;
    union {
...
static struct Value *rt_Integer__div__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *other = argv[1];
    struct Value *result;
    union {
...
static struct Value *rt_Integer__mod__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *other = argv[1];
    struct Value *result;
    union {
...
static struct Value *rt_Integer__and__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *other = argv[1];
    struct Value *result;
    union {
...
static struct Value *rt_Integer__or__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *other = argv[1];
    struct Value *result;
    union {
...
static struct Value *rt_Integer__xor__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *other = argv[1];
    struct Value *result;
    union {
...
static struct Value *rt_Integer__pow__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *other = argv[1];
    struct Value *result;
    union {
...
static struct Value *rt_Integer__neg__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *result;
    ValueMakeInteger(&result, -self->v.Integer);
    return result;
}
static struct Value *rt_Integer__pos__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    return self;
}
static struct Value *rt_Integer__lshift__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *other = argv[1];
    struct Value *result;
    union {
...
static struct Value *rt_Integer__rshift__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *other = argv[1];
    struct Value *result;
    union {
...
static struct Value *rt_Integer__eq__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *other = argv[1];
    if (IS_INTEGER(other)) {
...
static struct Value *rt_Integer__lt__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *other = argv[1];
    if (IS_INTEGER(other)) {
        if (self->v.Integer < other->v.Integer) {
...
static struct Value *rt_Integer__gt__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    struct Value *other = argv[1];
    if (IS_INTEGER(other)) {
        if (self->v.Integer > other->v.Integer) {
...
static struct Value *rt_Integer__str__(unsigned int argc, struct Value **argv) {
...
static struct Value *rt_Integer__hash__(unsigned int argc, struct Value **argv) {
    struct Value *self = argv[0];
    return self;
}
static struct Value *rt_Integer__dbg__(unsigned int argc, struct Value **argv) {
    return rt_Integer__str__(argc, argv);
}

#define INTEGER_METHOD_INSERT(name, numArgs, isVarArgs)                  \
    do {                                                                \
        struct Value *method;                                           \
        int result = FunctionMaker(&method, XSTR(name), numArgs, isVarArgs, GLUE2(rt_Integer, name)); \
        if (R_OK != result) {                                           \
            return result;                                              \
        }                                                               \
